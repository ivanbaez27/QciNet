...
Route::get('/majors', 'CarreraController@index')->name('major.index');
Route::resource('majors', 'CarreraController')->middleware('auth');
...
Route::post('/register/role', 'Auth\RegisterController@selectRole')->name('select.role');
Route::post('/verification',  'Auth\RegisterController@verification')->name('verification');
Route::patch('/index/{user}', 'Auth\RegisterController@storeRole')->name('store.role');

//datajson post
Route::get('/datapost','DatapostController@publicacioncompu');
